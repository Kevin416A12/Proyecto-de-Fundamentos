...
def actualizar_puntaje(puntos):
    ...
    if jugador1 == jugador_seleccionado:
        ...
        if canvas_actual == fondo_canvasa:
            ...
            puntaje1_canvas1 = fondo_canvasa.create_text(140, 500, text=f'Puntos: {puntaje_jugador1}',
                                                         font=("Aptos Black", 30),
        ...
        # Actualizar puntaje para jugador 1 en fondo_canvasa2
            ...
            puntaje1_canvas2 = fondo_canvasa2.create_text(140, 500, text=f'Puntos: {puntaje_jugador1}',
                                                          font=("Aptos Black", 30),
                                                          fill='#FEF9F2', anchor='center')
        ...
        if canvas_actual == fondo_canvasa:
            ...
            puntaje2_canvas1 = fondo_canvasa.create_text(140, 500, text=f'Puntos: {puntaje_jugador2}',
                                                         font=("Arial", 24),
                                                         fill='#FEF9F2', anchor='center')
        ...
        # Actualizar puntaje para jugador 2 en fondo_canvasa2
            ...
            puntaje2_canvas2 = fondo_canvasa2.create_text(140, 500, text=f'Puntos: {puntaje_jugador2}',
                                                          font=("Arial", 24),
                                                          fill='#FEF9F2', anchor='center')
    elif jugador1_1:
        print('jugador solo')
        ...
        if canvas_actual == fondo_canvasa1:
            ...
            puntaje_1jugador = fondo_canvasa.create_text(140, 500, text=f'Puntos: {puntaje_jugador1_1}',
                                                         font=("Arial", 24),
                                                         fill='#FEF9F2', anchor='center')
...
def ir_a_jugadores():
    ...
    regresar = Button(frame_jugadores, text='BACK', command=ir_a_inicio, bg='#243642',
                      borderwidth=8, highlightbackground='#257180', highlightcolor='#257180', font=('Helvetica', 17),
                      fg='white')
    ...
    dos_jugadores = Button(frame_jugadores, text='2 PLAYERS', command=dos_jugadores2, bg='#243642', width=20,
                           borderwidth=8, highlightbackground='#257180', highlightcolor='#257180',
                           font=('Helvetica', 17), fg='white')
...
def un_jugador1():
    ...
    boton_perro = Button(frame_1jugador, image=imagen_perro,
                         command=lambda: seleccionar_perfil_jugador1_1(imagen_perro), highlightcolor='red', highlightthickness= 2)
    boton_panda = Button(frame_1jugador, image=imagen_panda,
                         command=lambda: seleccionar_perfil_jugador1_1(imagen_panda), highlightcolor='red', highlightthickness= 2)
    boton_dinosaurio = Button(frame_1jugador, image=imagen_dinosaurio,
                              command=lambda: seleccionar_perfil_jugador1_1(imagen_dinosaurio), highlightcolor='red', highlightthickness= 2)
    boton_tigre = Button(frame_1jugador, image=imagen_tigre,
                         command=lambda: seleccionar_perfil_jugador1_1(imagen_tigre), highlightcolor='red', highlightthickness= 2)
    boton_gato = Button(frame_1jugador, image=imagen_gato, command=lambda: seleccionar_perfil_jugador1_1(imagen_gato), highlightcolor='red', highlightthickness= 2)
...
def dos_jugadores2():
    ...
    boton_perro1 = Button(frame_2jugadores, image=imagen_perro,
                          command=lambda: seleccionar_perfil_jugador1(imagen_perro))
    boton_panda1 = Button(frame_2jugadores, image=imagen_panda,
                          command=lambda: seleccionar_perfil_jugador1(imagen_panda))
    boton_dinosaurio1 = Button(frame_2jugadores, image=imagen_dinosaurio,
                               command=lambda: seleccionar_perfil_jugador1(imagen_dinosaurio))
    boton_tigre1 = Button(frame_2jugadores, image=imagen_tigre,
                          command=lambda: seleccionar_perfil_jugador1(imagen_tigre))
    ...
    boton_perro2 = Button(frame_2jugadores, image=imagen_perro,
                          command=lambda: seleccionar_perfil_jugador2(imagen_perro))
    boton_panda2 = Button(frame_2jugadores, image=imagen_panda,
                          command=lambda: seleccionar_perfil_jugador2(imagen_panda))
    boton_dinosaurio2 = Button(frame_2jugadores, image=imagen_dinosaurio,
                               command=lambda: seleccionar_perfil_jugador2(imagen_dinosaurio))
    boton_tigre2 = Button(frame_2jugadores, image=imagen_tigre,
                          command=lambda: seleccionar_perfil_jugador2(imagen_tigre))
...
def ventana_juego1():
    ...
    boton_scores = Button(frame_juego1, text='SCORES', command=lambda: (guardar_puntaje1(), ir_a_marcadores()),
                          width=20,
                          bg='#B6FFA1', borderwidth=8, highlightbackground='#257180',
                          highlightcolor='#257180', font=('Aptos Black', 20), fg='black')

    fondo_canvasa1.create_text(140, 100, text=f'Jugando: {jugador1_1}!', font=("Arial", 24), fill='#FEF9F2',
                               anchor='center')
...
def ventana_juego():
    ...
    # Botón de inicio
    boton_start = Button(frame_juego, text='START', command=lambda: iniciar_temporizador(60 ), width=20,
                         bg='#B6FFA1', borderwidth=8, highlightbackground='#257180',
                         highlightcolor='#257180', font=('Aptos Black', 20), fg='black')
    ...
    if jugador_seleccionado:
        fondo_canvasa.create_text(140, 100, text=f'Jugando: {jugador_seleccionado}!', font=("Arial", 24),
                                  fill='#FEF9F2', anchor='center')
...
def ventana_juego2():
    ...
    # Botón de inicio
    boton_start2 = Button(frame_juego2, text='START', command=lambda: iniciar_temporizador(60), width=20,
                          bg='#B6FFA1', borderwidth=8, highlightbackground='#257180',
                          highlightcolor='#257180', font=('Aptos Black', 20), fg='black')
    ...
    if jugador_seleccionado:
        fondo_canvasa2.create_text(140, 100, text=f'Jugando: {jugador_seleccionado}!', font=("Arial", 24),
                                   fill='#FEF9F2', anchor='center')
        imagen_perfil_jugador = obtener_imagen_perfil(jugador_seleccionado)
        if imagen_perfil_jugador:
...
def actualizar_temporizador():
    ...
    if tiempo_restante > 0:
        ...
        texto_temporizador = canvas_actual.create_text(700, 90, text=tiempo_formateado, font=("Aptos Black", 80),
                                                       fill='#00FF9C', anchor='center')
        ...
        canvas_actual.delete(texto_temporizador)
        canvas_actual.create_text(680, 300, text="¡Tiempo agotado! ", font=("Aptos Black", 50), fill='red',
                                  anchor='center')
...
def actualizar_temporizador1():
    ...
    if tiempo_restante1 > 0:
        ...
        # Crear el nuevo texto del temporizador en el canvas activo
        texto_temporizador1 = fondo_canvasa1.create_text(700, 90, text=tiempo_formateado1, font=("Aptos Black", 80),
                                                         fill='#00FF9C', anchor='center')
        ...
        fondo_canvasa1.delete(texto_temporizador1)
        fondo_canvasa1.create_text(680, 300, text="¡Tiempo agotado! ", font=("Aptos Black", 50), fill='red',
                                   anchor='center')
        if 'boton_scores' in globals():
            boton_scores.place(x=650, y=750)
