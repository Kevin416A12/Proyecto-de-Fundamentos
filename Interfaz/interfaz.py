...
def ventana_juego1():
    ...
    # Botón de inicio
    boton_start1 = Button(frame_juego1, text='START', command=lambda: iniciar_temporizador1(2), width=20,
...
def ventana_juego():
    global frame_juego, fondo_canvasa, boton_start, boton_siguiente, canvas_actual,fondo_canvasa
...
def ventana_juego2():
    global frame_juego2, fondo_canvasa2, boton_start2, canvas_actual,boton_scores,fondo_canvasa2
    ...
    boton_scores= Button(frame_juego2, text='SCORES', command=ir_a_marcadores, width=20,
                          bg='#B6FFA1', borderwidth=8, highlightbackground='#257180', 
                          highlightcolor='#257180', font=('Aptos Black', 20), fg='black')
